...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    // protected $namespace = Baytek\Laravel\Content\Types\Document::class;
    ...
    public function map()
    {
        if(config('document.routes.enabled')) {
            $this->mapAdminRoutes();
            $this->mapApiRoutes();
            $this->mapWebRoutes();
        }
    ...
    {
        $routes = 'routes/admin/document.php';
    ...
    {
        $routes = 'routes/api/document.php';
        if(file_exists(base_path($routes))){
    ...
    {
        $routes = 'routes/web/document.php';
        if(file_exists(base_path($routes))){
